...
class science_class_12(models.Model):
    student=models.OneToOneField(student_main,on_delete=models.CASCADE,unique=True)
...
# class mgmt_class_12(models.Model):
...
#         self.percentage=a1
#         self.result=result
#         super(mgmt_class_12, self).save(*args, **kwargs)
#     def clean(self):
#         super(mgmt_class_12, self).clean()
#         if self.bio is None and self.comp is None:
#             raise ValidationError('bio and comp one need to be filled')
#         elif not (self.bio  and self.comp) is None:
#             raise ValidationError('both bio and comp cant be filled..please check') 
...
# class mgmt_class_11(models.Model):
#     student=models.OneToOneField(Citizen,on_delete=models.CASCADE,unique=True)
#     phy= models.FloatField(validators=[MaxValueValidator(75)])
#     phy_prac= models.FloatField(validators=[MaxValueValidator(25)])
#     math= models.FloatField(validators=[MaxValueValidator(75)]) 
...
#         self.percentage=a1
#         self.result=result
#         super(mgmt_class_11, self).save(*args, **kwargs)
#     def clean(self):
#         super(mgmt_class_11, self).clean()
#         if self.bio is None and self.comp is None:
#             raise ValidationError('bio and comp one need to be filled')
#         elif not (self.bio  and self.comp) is None:
#             raise ValidationError('both bio and comp cant be filled..please check') 
